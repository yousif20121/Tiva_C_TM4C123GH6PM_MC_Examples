...
extern void UART0_SendByte(const uint8 data);

extern uint8 UART0_ReceiveByte(void);

extern void UART0_SendString(const uint8* dataP);

extern void UART0_ReceiveString(uint8* dataP);

extern void UART0_SendData(const uint8 *dataP, uint32 uSize);

extern void UART0_ReceiveData(uint8 *dataP, uint32 uSize);
